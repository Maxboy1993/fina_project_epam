...
public class FilmRatingDaoImpl implements FilmRatingDao<FilmRaiting>
{
    private static final FilmRatingDao<FilmRaiting> INSTANCE = new FilmRatingDaoImpl();

    private FilmRatingDaoImpl() {
    }

    public static FilmRatingDao<FilmRaiting> getInstance() {
        return INSTANCE;
    }
