...
public class SqlQuery {
    ...
    public static final String FIND_USER_BY_LOGIN_AND_PASSWORD = "SELECT userId, firstName, lastName, birthday, " +
            "login, password, status, role FROM User WHERE User.login = ? AND User.password = ?";
    ...
    public static final String FIND_ALL_FILMS = "SELECT filmId, filmName, releaseDate, genre, status FROM film WHERE status = " + ACTIVE_STATUS;
