...
import by.nareiko.films_raiting.model.dao.FilmsDao;
...
public class FilmDaoImpl implements FilmsDao<Film> {
    ...
    private Film film;
    private static final String FIND_ALL_FILMS = "SELECT Film.filmId, Film.name, Film.genreId, Genre.genre, Film.releaseDate, Film.actorId, " +
            ...
            "JOIN Actor ON Film.actorId = Actor.actorId JOIN Director ON Film.directorId = Director.directorId";
    private static final String FIND_FILM_BY_NAME = "SELECT Film.filmId, Film.name, Film.genreId, Genre.genre, Film.releaseDate, Film.actorId, " +
            "Actor.name, Actor.birthday, Film.directorId, Director.name, Director.birthday, Film.statusId, Status.status FROM Film JOIN Status ON Film.statusId = Status.statusId " +
            "JOIN Actor ON Film.actorId = Actor.actorId JOIN Director ON Film.directorId = Director.directorId WHERE Film.name = ?";
